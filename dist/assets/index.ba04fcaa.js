var $e=Object.defineProperty,_e=Object.defineProperties;var Ie=Object.getOwnPropertyDescriptors;var K=Object.getOwnPropertySymbols;var Ne=Object.prototype.hasOwnProperty,Se=Object.prototype.propertyIsEnumerable;var ee=(n,t,o)=>t in n?$e(n,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):n[t]=o,U=(n,t)=>{for(var o in t||(t={}))Ne.call(t,o)&&ee(n,o,t[o]);if(K)for(var o of K(t))Se.call(t,o)&&ee(n,o,t[o]);return n},Y=(n,t)=>_e(n,Ie(t));import{j as W,r as a,s as i,l as Le,u as H,B as He,S as te,R as z,a as ze}from"./vendor.2d340bfb.js";const Pe=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const p of l.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&r(p)}).observe(document,{childList:!0,subtree:!0});function o(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerpolicy&&(l.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?l.credentials="include":s.crossorigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function r(s){if(s.ep)return;s.ep=!0;const l=o(s);fetch(s.href,l)}};Pe();const e=W.exports.jsx,d=W.exports.jsxs,E=W.exports.Fragment,ne=a.exports.createContext({}),Me=n=>{const{children:t}=n,[o,r]=a.exports.useState({});return e(ne.Provider,{value:{myInfo:o,setMyInfo:r},children:t})},B=()=>a.exports.useContext(ne),oe=a.exports.memo(n=>{const{children:t}=n;return e(je,{children:t})}),je=i.div`
  background-image: url('/assets/images/bg_common.jpg');
  background-size: 600px auto;
  background-repeat: repeat;
`,re=a.exports.memo(n=>{const{children:t}=n;return e(Te,{children:t})}),Te=i.div`
  display: flex;
  align-items: center;
...
`,m=Le(),ie=()=>{const{setMyInfo:n}=B(),t=()=>{const s=8,l="abcdefghijklmnopqrstuvwxyz0123456789";let p="";for(let u=0;u<s;u++)p+=l[Math.floor(Math.random()*l.length)];return p},o=()=>{const s=151,l=`${Math.floor(Math.random()*s)+1}`;let p;return l.length===1?p=`00${l}`:l.length===2?p=`0${l}`:p=l,p};return{setInfo:a.exports.useCallback((s,l)=>{const p={id:t(),name:s,icon:o(),isAdmin:l};n(p),m.emit("common:newUser",p)},[]),randomIcon:o}},Ze=()=>{const n=H(),{setInfo:t}=ie();return{enter:a.exports.useCallback(r=>{r==="$clear"?m.emit("common:clearUser"):(t(r==="admin"?"\u3044\u308F\u3082\u3068":r,r==="admin"),n.push("/lobby"))},[])}},Xe=a.exports.memo(()=>{const[n,t]=a.exports.useState(""),[o,r]=a.exports.useState(!0),{enter:s}=Ze();return e(Ve,{children:d(Qe,{children:[e(P,{text:"Games House"}),e(Ue,{value:n,placeholder:"\u30E6\u30FC\u30B6\u30FC\u540D\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044",onChange:u=>{t(u.target.value),u.target.value?r(!1):r(!0)}}),e(F,{label:"Join the game!",isDisabled:o,onclick:()=>s(n)})]})})}),Ve=i.div`
  display: flex;
  align-items: center;
  justify-content: center;
  min-height: 100vh;
...
`,qe=a.exports.memo(()=>null),J=a.exports.memo(n=>{const{children:t,options:o,value:r,onChange:s,disabled:l,hdg:p}=n;return d(Ke,{children:[e(tt,{children:p}),d(et,{value:r,onChange:s,disabled:!l,children:[t,o.map(u=>e("option",{value:u.key,children:u.value},u.value))]})]})}),Ke=i.div`
  display: grid;
...
`,tt=i.div`
  font-size: 14px;
  font-weight: bold;
`,nt=[{key:4,value:"4\u8272"},{key:5,value:"5\u8272"},{key:6,value:"6\u8272"}],ot=[{key:3,value:"3\u679A"},{key:4,value:"4\u679A"},{key:5,value:"5\u679A"}],rt=a.exports.memo(()=>{const{myInfo:n}=B(),[t,o]=a.exports.useState(null),[r,s]=a.exports.useState(null);a.exports.useEffect(()=>{m.on("hanabi:updateConfig",u=>{o(u.colorNum),s(u.handNum)}),m.emit("hanabi:getConfig")},[]);const l=u=>{m.emit("hanabi:setColorNum",u.target.options[u.target.selectedIndex].value)},p=u=>{m.emit("hanabi:setHandNum",u.target.options[u.target.selectedIndex].value)};return d(it,{children:[e(ae,{children:e(J,{options:nt,hdg:"\u8272\u306E\u6570",value:t||"",onChange:l,disabled:n.isAdmin})}),e(ae,{style:{marginTop:"10px"},children:e(J,{options:ot,hdg:"\u624B\u672D\u306E\u679A\u6570",value:r||"",onChange:p,disabled:n.isAdmin})})]})}),it=i.div``,ae=i.div`
  display: flex;
  justify-content: center;
  select {
    width: 150px;
  }
`,$=a.exports.memo(n=>{const{name:t,icon:o,editIcon:r,editName:s}=n,{myInfo:l,setMyInfo:p}=B(),[u,h]=a.exports.useState(!1),[f,k]=a.exports.useState(l.name),{randomIcon:C}=ie(),A=()=>{p(Y(U({},l),{icon:C()}))},w=()=>{h(!u),u&&p(Y(U({},l),{name:f}))},x=g=>k(g.target.value);return a.exports.useEffect(()=>{m.emit("common:updateInfo",l)},[l]),d(at,{className:"profile",children:[d(st,{className:"profile__img",children:[e("img",{src:`/assets/images/pokemon/${o}.png`}),r&&e(lt,{onClick:A,children:r})]}),u?e(ct,{type:"text",value:f,onChange:x}):e(dt,{className:"profile__name",children:t}),s&&e(ut,{onClick:w,className:u?"isEdit":"",children:s})]})}),at=i.li`
  display: flex;
  align-items: center;
  padding: 5px 10px;
  background: ${c.gray[0]};
...
`;let N=!1,Z=0,X=0;const Et=a.exports.memo(n=>{const{gameData:t,setCanvas:o,color:r,disable:s,status:l,isFake:p,onclickAnswer:u}=n;return a.exports.useEffect(()=>{const h=document.getElementById("canvas"),f=h.getContext("2d");f.lineCap="round",f.lineWidth=4,f.strokeStyle=r,h.addEventListener("mousedown",C=>{N=!0,Z=C.offsetX,X=C.offsetY}),h.addEventListener("mousemove",C=>{if(!N)return;const A=C.offsetX,w=C.offsetY;k(f,Z,X,A,w),Z=A,X=w}),h.addEventListener("mouseout",()=>{!N||(N=!1,o(h))}),h.addEventListener("mouseup",()=>{!N||(N=!1,o(h))});const k=(C,A,w,x,g)=>{C.beginPath(),C.moveTo(A,w),C.lineTo(x,g),C.stroke()}},[]),a.exports.useEffect(()=>{const f=document.getElementById("canvas").getContext("2d");if(t.context.length){const k=new Image;k.src=t.context,k.onload=()=>f.drawImage(k,0,0)}},[t.context]),d(Dt,{children:[e($t,{id:"canvas",width:750,height:500,className:s||l!=="game"?"disable":""}),e(_t,{className:l==="theme"?"is-active":"",children:d("p",{children:["\u304A\u984C\u3092\u78BA\u8A8D\u3057\u3066\u4E0B\u3055\u3044",e("br",{}),"10\u79D2\u5F8C\u306B\u30B2\u30FC\u30E0\u304C\u958B\u59CB\u3057\u307E\u3059"]})}),e(S,{className:l==="title"?"is-active":"",children:p?d("p",{children:["\u304A\u984C\u3092\u77E5\u3063\u3066\u3044\u308B\u30D5\u30EA\u3092\u3057\u3066",e("br",{}),"\u30D0\u30EC\u306A\u3044\u3088\u3046\u306B\u7D75\u3092\u63CF\u3053\u3046"]}):d("p",{children:["\u5354\u529B\u3057\u3066\u7D75\u3092\u63CF\u3053\u3046",e("br",{}),"\u305F\u3060\u3057\u30A8\u30BB\u82B8\u8853\u5BB6\u306B\u304A\u984C\u304C\u30D0\u30EC\u3066\u306F\u3044\u3051\u306A\u3044"]})}),e(S,{style:{animationDelay:"1s"},className:l==="vote"?"is-active":"",children:d("p",{children:["\u30A8\u30BB\u82B8\u8853\u5BB6\u3060\u3068\u601D\u3046\u4EBA\u306B",e("br",{}),"\u6295\u7968\u3057\u3066\u304F\u3060\u3055\u3044"]})}),l==="voted"&&d(E,{children:[e(S,{className:l==="voted"?"is-active":"",children:"\u6295\u7968\u7D50\u679C\u767A\u8868"}),d(It,{children:[e("p",{children:"\u6700\u591A\u6295\u7968\u8005\u306F..."}),e(pe,{children:t.mostVote}),e("p",{style:{marginTop:"50px"},children:"\u30A8\u30BB\u82B8\u8853\u5BB6\u306F..."}),e(pe,{children:t.players[t.fakeMan].name})]}),e(S,{className:l==="voted"?"is-active":"",style:{animationDelay:"15s"},children:t.mostVote===t.players[t.fakeMan].name?d("p",{children:["\u30A8\u30BB\u82B8\u8853\u5BB6\u304C",e("br",{}),"\u304A\u984C\u3092\u5F53\u3066\u308B\u3053\u3068\u304C\u3067\u304D\u308C\u3070\u9006\u8EE2\u52DD\u5229"]}):e("p",{children:"\u30A8\u30BB\u82B8\u8853\u5BB6\u306E\u52DD\u5229!!"})})]}),l==="reversal"&&e(Nt,{className:p?"":"disable",children:e("ul",{children:t.answerList.map((h,f)=>e("li",{style:{animationDelay:`${f*.1}s`},onClick:()=>u(f),children:h},h))})}),l==="answer"&&d(E,{children:[d(St,{children:[d("div",{children:[e("p",{className:"hdg",children:"\u30A8\u30BB\u82B8\u8853\u5BB6\u306E\u56DE\u7B54"}),e("p",{className:"card",children:t.answer})]}),d("div",{children:[e("p",{className:"hdg",style:{marginTop:"50px"},children:"\u6B63\u89E3"}),e("p",{className:"card",children:t.theme})]})]}),e(S,{className:"modal is-active",children:t.answer===t.theme?e("p",{children:"\u30A8\u30BB\u82B8\u8853\u5BB6\u306E\u52DD\u5229!!"}):e("p",{children:"\u82B8\u8853\u5BB6\u306E\u52DD\u5229!!"})})]})]})}),Dt=i.div`
  position: relative;
  width: 750px;
  height: 100%;
`,$t=i.canvas`
...
`,V=()=>{const n=H();return a.exports.useEffect(()=>{m.on("common:toLobby",()=>{n.push("/lobby")})},[]),{toLobby:a.exports.useCallback(()=>{m.emit("common:toLobby")},[])}},D="fakeArtist",Ht=a.exports.memo(()=>{const[n,t]=a.exports.useState({}),[o,r]=a.exports.useState(null),{myInfo:s}=B(),[l,p]=a.exports.useState(""),[u,h]=a.exports.useState(!1),{toLobby:f}=V();a.exports.useEffect(()=>{m.on(`${D}:getData`,x=>t(x)),m.on(`${D}:vote`,()=>p("vote")),m.on(`${D}:voted`,()=>p("voted")),m.on(`${D}:reversal`,x=>{t(x),p("reversal")}),m.on(`${D}:answer`,x=>{t(x),p("answer")}),m.on(`${D}:finish`,x=>{t(x),p("finish")}),m.emit(`${D}:getData`),setTimeout(()=>p("theme"),500),setTimeout(()=>p("title"),10500),setTimeout(()=>p("game"),16e3)},[]);const k=()=>{const x=o==null?void 0:o.toDataURL();m.emit(`${D}:draw`,x),r(null)},C=()=>{const x=o==null?void 0:o.getContext("2d");if(x.clearRect(0,0,750,500),n.context.length){const g=new Image;g.src=n.context,g.onload=()=>x.drawImage(g,0,0)}r(null)},A=x=>{h(!0),m.emit(`${D}:vote`,x)},w=x=>m.emit(`${D}:answer`,x);return Object.keys(n).length?d(zt,{children:[l==="game"&&e(M,{turn:n.players[n.turn].name}),l==="game"&&(o?d(Pt,{children:[e("p",{children:"\u3053\u308C\u3067\u3044\u3044?"}),e("button",{style:{backgroundColor:c.green[0]},onClick:k,children:"\u66F8\u3044\u305F\uFF01"}),e("button",{style:{backgroundColor:c.gray[1]},onClick:C,children:"\u66F8\u304D\u76F4\u3059\uFF01"})]}):n.players[n.fakeMan].id===s.id?d(j,{children:["\u30A8\u30BB\u82B8\u8853\u5BB6\u3060\u3068\u30D0\u30EC\u3066\u306F\u3044\u3051\u306A\u3044",e("br",{}),"\u30D0\u30EC\u3066\u3082\u4F55\u3092\u63CF\u3044\u3066\u3044\u308B\u304B\u5F53\u3066\u308C\u3070\u52DD\u3061"]}):d(j,{children:["\u3053\u306E\u4E2D\u306B\u4E00\u4EBA\u304A\u984C\u3092\u77E5\u3089\u306A\u3044\u30A8\u30BB\u82B8\u8853\u5BB6\u304C\u3044\u308B",e("br",{}),"\u30A8\u30BB\u82B8\u8853\u5BB6\u306B\u304A\u984C\u304C\u30D0\u30EC\u3066\u306F\u3044\u3051\u306A\u3044"]})),l==="vote"&&e(j,{children:"\u30A8\u30BB\u82B8\u8853\u5BB6\u306F\u8AB0\u3060\uFF1F"}),l==="reversal"&&e(j,{children:"\u30A8\u30BB\u82B8\u8853\u5BB6\u304C\u56DE\u7B54\u3092\u9078\u629E\u3059\u308B"}),l==="finish"&&d(Mt,{children:[n.answer?n.answer===n.theme?"\u30A8\u30BB\u82B8\u8853\u5BB6":"\u82B8\u8853\u5BB6":"\u30A8\u30BB\u82B8\u8853\u5BB6","\u306E\u52DD\u5229!!"]}),d(jt,{children:[e(Et,{gameData:n,setCanvas:r,color:n.colors[n.players.findIndex(x=>x.id===s.id)],disable:!!(o||n.players[n.turn].id!==s.id),status:l,isFake:n.players[n.fakeMan].id===s.id,onclickAnswer:w}),d(Tt,{children:[d(me,{children:[e("span",{children:"\u4ECA\u56DE\u306E\u30C6\u30FC\u30DE"}),e(he,{children:n.category})]}),d(me,{style:{marginTop:"10px"},children:[e("span",{children:"\u4ECA\u56DE\u306E\u304A\u984C"}),e(he,{children:n.players[n.fakeMan].id!==s.id?n.theme:"?"})]}),e(Ot,{children:n.players.map((x,g)=>l==="vote"?d(ge,{style:{borderColor:n.colors[g]},children:[u?e(xe,{children:e("img",{src:`/assets/images/pokemon/${x.icon}.png`})}):e(Rt,{onClick:()=>A(g),children:"\u6295\u7968"}),e(fe,{children:x.name})]},x.id):d(ge,{style:{borderColor:n.colors[g]},children:[e(xe,{children:e("img",{src:`/assets/images/pokemon/${x.icon}.png`})}),e(fe,{children:x.name})]},x.id))})]})]}),l==="finish"&&s.isAdmin&&e("div",{style:{marginTop:"30px",textAlign:"center"},children:e(F,{label:"\u30ED\u30D3\u30FC\u306B\u623B\u308B",onclick:f,color:"teal"})})]}):null}),zt=i.div`
  position: relative;
  margin-top: 150px;
  margin-bottom: 150px;
`,Pt=i.div`
...
`,be=a.exports.memo(n=>{const{color:t,num:o,colorHint:r,numHint:s,isReverse:l,onclick:p}=n,u=()=>{let h="";return r&&(h+=`hint_${t}`),s&&(h=h===""?`hint_${o}`:`${h} hint_${o}`),h};return e(E,{children:l?e(ye,{className:`reverse hand ${(r||s)&&u()}`,onClick:p}):e(ye,{className:`${t} hand ${(r||s)&&u()}`,onClick:p,children:o!==0&&o})})}),ye=i.div`
  width: 60px;
  height: 120px;
  padding-top: 5px;
  font-size: 36px;
...
`,Jt=a.exports.memo(n=>{const{deck:t,fields:o}=n;return d(Zt,{children:[e(Xt,{children:t}),e(Vt,{children:o.map((r,s)=>e(be,{color:r.color,num:r.num},s))})]})}),Zt=i.div`
  display: flex;
  justify-content: space-between;
  margin-bottom: 30px;
  padding: 20px;
...
`,nn=a.exports.memo(n=>{const{name:t,hands:o,onclick:r,isFinish:s}=n,{myInfo:l}=B();return d(on,{className:"player",children:[e(rn,{children:o.map((p,u)=>e(be,{color:p.color,num:p.num,colorHint:p.colorHint,numHint:p.numHint,isReverse:s?!1:t===l.name,onclick:r},u))}),d(an,{children:["\u27A1\uFE0E ",t]})]})}),on=i.div`
  min-width: 310px;
`,rn=i.div`
  display: flex;
...
`,Q=a.exports.memo(n=>{const{num:t,isHide:o,onclick:r,selected:s}=n,l=p=>p===0?"empty":p%2==0?"black":"white";return e(E,{children:o?e(we,{className:l(t)}):e(we,{onClick:r,className:`${s&&"isActive"} ${l(t)}`,children:t})})}),we=i.div`
  width: 100%;
  height: 100%;
  line-height: 50px;
  font-size: 20px;
...
`,ke=a.exports.memo(n=>{const{hands:t,isHide:o,isFinish:r}=n,s=[...t];for(;s.length<9;)s.push(0);return e(gn,{children:s.map((l,p)=>e(Q,{num:l,isHide:r?!1:o},p))})}),gn=i.div`
  display: grid;
  grid-template-columns: repeat(1, 50px);
  grid-template-rows: repeat(9, 50px);
  gap: 10px;
`,ve=a.exports.memo(n=>{const{result:t}=n,{toLobby:o}=V(),r=l=>l==="WIN"?"win":l==="LOSE"?"lose":"draw",s=()=>o();return d(xn,{children:[e(fn,{className:r(t),children:t}),e(F,{label:"\u30ED\u30D3\u30FC\u306B\u623B\u308B",onclick:s,color:"teal"})]})}),xn=i.div`
  width: 332px;
  min-height: 244px;
  padding: 20px;
  background: #edf2f7;
...
`,Be=a.exports.memo(n=>{const{hands:t,turn:o,isPlayer:r,isHide:s}=n,{myInfo:l}=B(),[p,u]=a.exports.useState(!1),[h,f]=a.exports.useState(null);a.exports.useEffect(()=>{u(h!==null)},[h]);const k=A=>f(A),C=()=>{f(null),m.emit("kowloonTactics:selectHand",[l,h])};return d(bn,{children:[e(yn,{className:r?"":"disabed",children:t.map((A,w)=>s?e(Q,{num:A,isHide:!0},w):e(Q,{num:A,onclick:()=>k(w),selected:h===w&&!0},w))}),r&&o&&e(F,{label:"\u30AB\u30FC\u30C9\u3092\u51FA\u3059",onclick:C,color:"teal",isDisabled:!p})]})}),bn=i.div`
  width: 332px;
  min-height: 244px;
  padding: 20px;
  background: #edf2f7;
...
`,Cn=a.exports.memo(n=>{const{judgeArray:t}=n,o=[...t];for(;o.length<9;)o.push("empty");return d(An,{children:[e(Fe,{className:"red",children:o.map((r,s)=>e("div",{className:r},s))}),e(Fe,{className:"blue",children:o.map((r,s)=>e("div",{className:r},s))})]})}),An=i.div`
  display: flex;
  width: 50px;
  pointer-events: none;
`,Fe=i.div`
...
`,Ee=a.exports.memo(n=>{const{player:t,supporter:o,area:r}=n;return d(wn,{className:r,children:[e("span",{children:"\u30D7\u30EC\u30A4\u30E4\u30FC"}),e($,{name:t.name,icon:t.icon}),o.length>0&&e("span",{style:{marginTop:"15px"},children:"\u30B5\u30DD\u30FC\u30BF\u30FC"}),e(kn,{children:o.map(s=>e($,{name:s.name,icon:s.icon},s.id))})]})}),wn=i.div`
  position: absolute;
  top: 0;
  width: 200px;
  min-height: 300px;
...
`,_=40,O=a.exports.memo(n=>{const{cards:t,isReverse:o,onclick:r}=n;return e($n,{className:o?"reverse":"",onClick:r,children:t.map(s=>e(De,{num:s},s))})}),$n=i.div`
  position: relative;
  height: 348px;
...
`,_n=a.exports.memo(n=>{const{fieldCards:t,playCard:o}=n;return d(In,{children:[d(R,{children:[e(T,{from:"100"}),e(O,{cards:t[0],onclick:()=>o(0)})]}),d(R,{children:[e(T,{from:"100"}),e(O,{cards:t[1],onclick:()=>o(1)})]}),d(R,{className:"reverse",children:[e(T,{from:"1"}),e(O,{cards:t[2],isReverse:!0,onclick:()=>o(2)})]}),d(R,{className:"reverse",children:[e(T,{from:"1"}),e(O,{cards:t[3],isReverse:!0,onclick:()=>o(3)})]})]})}),In=i.div`
  display: flex;
  justify-content: space-between;
  width: 600px;
`,R=i.div`
...
`,Ln=a.exports.memo(n=>{const{hands:t,selectedHand:o,setSelectedHand:r}=n;return d(Hn,{children:[e("p",{style:{fontWeight:"bold"},children:"\u3042\u306A\u305F\u306E\u624B\u672D"}),e(zn,{children:t.map((s,l)=>e(De,{num:s,selected:o===l,onclick:()=>r(l)},s))})]})}),Hn=i.div`
  width: 100%;
  margin-top: 30px;
`,zn=i.ul`
  display: flex;
...
`,Tn=a.exports.memo(n=>{const{status:t,remainingHand:o,turnFinish:r,turnContinue:s}=n;return e(On,{children:t==="continue"?d(Gn,{children:[e("p",{children:"\u307E\u3060\u30AB\u30FC\u30C9\u3092\u51FA\u3057\u307E\u3059\u304B?"}),e("button",{style:{backgroundColor:c.gray[1]},onClick:r,children:"\u51FA\u3055\u306A\u3044"}),e("button",{style:{backgroundColor:c.green[0]},onClick:s,children:"\u51FA\u3059"})]}):e(Rn,{children:o<=0?"\u624B\u672D\u304B\u3089\u30AB\u30FC\u30C9\u3092\u51FA\u3057\u3066\u304F\u3060\u3055\u3044":`\u3042\u3068${o}\u679A\u306E\u30AB\u30FC\u30C9\u3092\u51FA\u3057\u3066\u304F\u3060\u3055\u3044`})})}),On=i.div`
  position: fixed;
  left: 0;
  right: 0;
  top: 70px;
...
`,G="theGame",Un=a.exports.memo(()=>{const{myInfo:n}=B(),[t,o]=a.exports.useState({}),[r,s]=a.exports.useState("remaining"),[l,p]=a.exports.useState(null),[u,h]=a.exports.useState(2);a.exports.useEffect(()=>{m.on(`${G}:getData`,g=>o(g)),m.emit(`${G}:getData`)},[]);const f=g=>{var y;if(l===null)return;const v={userId:n.id,selectIndex:l,fieldIndex:g};m.emit(`${G}:playCard`,v),p(null),h(u-1),((y=t.playerList.find(b=>b.user.id===n.id))==null?void 0:y.hand.length)===1?k():u-1<=0&&s("continue")},k=()=>{console.log("fin"),m.emit(`${G}:turnFinish`),h(2),s("remaining")},C=()=>s("remaining"),A=()=>w(t).id!==n.id||r==="continue"?"is-disabled":"",w=g=>g.playerList[g.turn].user,x=g=>g.find(v=>v.user.id===n.id).hand;return Object.keys(t).length?d(E,{children:[e(M,{turn:w(t).name}),w(t).id===n.id&&e(Tn,{status:r,remainingHand:u,turnFinish:k,turnContinue:C}),d(Yn,{className:A(),children:[e(_n,{fieldCards:t.fieldCards,playCard:f}),d("div",{style:{width:"450px"},children:[e(Nn,{deck:t.deck.length,score:t.score}),e(Ln,{hands:x(t.playerList),selectedHand:l,setSelectedHand:p})]}),e(Pn,{playerList:t.playerList})]})]}):null}),Yn=i.div`
  display: flex;
  justify-content: space-between;
  position: relative;
  width: 1100px;
